...
"""
                                .formatted(
                                        ...
                                        MailTemplate.actionButton(link, "Reset password")));
        mailService.sendHtml(user.getEmail(), "Reset your FinTrack Pro password", body);
        auditService.success(
                AuditAction.PASSWORD_RESET_REQUESTED, user.getId(), user.getUsername());
    }
    ...
    public void confirmReset(String token, String newPassword) {
                        ...
                        .orElseThrow(
                                () ->
                                        new BusinessRuleException(
                                                "Invalid reset link", "RESET_TOKEN_INVALID"));
        ...
        auditService.success(
                AuditAction.PASSWORD_RESET_CONFIRMED, user.getId(), user.getUsername());
    }
