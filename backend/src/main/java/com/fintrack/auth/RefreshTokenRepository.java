...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, UUID> {
    ...
    List<RefreshToken> findByUserIdAndExpiresAtAfterOrderByLastUsedAtDesc(UUID userId, Instant cutoff);
    ...
    /** Delete all refresh tokens for a user except one (e.g. keep current session after password change). */
    @Modifying
