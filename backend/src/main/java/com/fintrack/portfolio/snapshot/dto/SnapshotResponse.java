...
public record SnapshotResponse(
    ...
    public static SnapshotResponse from(PortfolioSnapshot snapshot) {
        BigDecimal value = snapshot.getTotalValueTry() != null ? snapshot.getTotalValueTry() : BigDecimal.ZERO;
        BigDecimal cost = snapshot.getTotalCostTry() != null ? snapshot.getTotalCostTry() : BigDecimal.ZERO;
